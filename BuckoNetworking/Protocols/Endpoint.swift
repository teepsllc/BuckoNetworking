...
/**
    Conform to Endpoint to create new endpoints to use with Bucko. This should only be used with classes or structs.
...
/**
 Conform to EnumEndpoint to create new endpoints to use with Bucko. This should only be used with enums.
 You can create an extension to create default values. This is recommended for the baseURL.
 */
public protocol EnumEndpoint {
    var baseURL: String { get } // https://example.com
    var path: String { get } // /users/
